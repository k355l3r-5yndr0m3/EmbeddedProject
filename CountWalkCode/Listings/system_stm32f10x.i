...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "RTE/Device/STM32F103C8/system_stm32f10x.c" 2
# 64 "RTE/Device/STM32F103C8/system_stm32f10x.c"
...
# 65 "RTE/Device/STM32F103C8/system_stm32f10x.c" 2
# 163 "RTE/Device/STM32F103C8/system_stm32f10x.c"
  uint32_t SystemCoreClock = ((uint32_t)8000000);


volatile const uint8_t AHBPrescTable[16] = {0, 0, 0, 0, 0, 0, 0, 0, 1, 2, 3, 4, 6, 7, 8, 9};
# 175 "RTE/Device/STM32F103C8/system_stm32f10x.c"
static void SetSysClock(void);
# 211 "RTE/Device/STM32F103C8/system_stm32f10x.c"
...
# 261 "RTE/Device/STM32F103C8/system_stm32f10x.c"
  SetSysClock();
...
# 305 "RTE/Device/STM32F103C8/system_stm32f10x.c"
void SystemCoreClockUpdate (void)
{
  uint32_t tmp = 0, pllmull = 0, pllsource = 0;
# 318 "RTE/Device/STM32F103C8/system_stm32f10x.c"
...
# 399 "RTE/Device/STM32F103C8/system_stm32f10x.c"
      break;
...
static void SetSysClock(void)
{
# 436 "RTE/Device/STM32F103C8/system_stm32f10x.c"
}
